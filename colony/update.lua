...
-- COLONY UPDATER
-- ============================================
-- Smart update system for CC:Tweaked turtles
--
-- Usage on turtle:
...
--   wget run https://raw.githubusercontent.com/bradley200813/minecraft/main/colony/update.lua force
...
local FILES = {
    ...
    {path = "update.lua", critical = false},
}
...
local function checkForUpdates()
    ...
    elseif remote_v == nil then
        return nil, "Could not fetch remote version"
    else
...
local function updateAll(force)
    ...
    if not http then
        ...
        print("Edit computercraft-server.toml to enable HTTP")
        return false
    end
    ...
    for _, file in ipairs(FILES) do
        ...
        sleep(0.1)  -- Small delay to not hammer the server
    end
